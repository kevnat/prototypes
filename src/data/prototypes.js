...
let prototypeData = [
    ...
    {
      id: 'lockbox-workbench',
      title: 'Lockbox Workbench',
      description: 'Unified invoice allocation workbench — rule-matched invoices pre-ticked at top of a single list, editable amounts, and a three-number summary (Payment / Allocated / Unapplied) with unallocated remainder handling',
      category: 'Payments',
      status: 'early',
      priority: 'high',
      ...
      author: 'Product Team',
      comments: 0,
      tags: ['payments', 'lockbox', 'cash-app', 'allocation', 'workbench', 'matching'],
      thumbnail: '🔧',
      progress: 20,
      route: '/prototypes/lockbox-workbench',
      featured: true,
      screenshot: '/images/allocation_dashboard.png',
      insights: 'Addresses Fiona feedback: unified invoice list with pre-matched invoices at top, all editable in one place',
    },
    {
      id: 'api-docs',

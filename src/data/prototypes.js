...
let prototypeData = [
    ...
    },
    {
      ...
      description: 'Payment record detail page — summary fields, lockbox tracing, cross-account allocations, and GL entries',
      category: 'Payments',
      status: 'early',
      priority: 'high',
      ...
      author: 'Product Team',
      comments: 0,
      tags: ['payments', 'detail', 'lockbox', 'allocation', 'gl', 'cash-app'],
      thumbnail: '🧾',
      progress: 40,
      route: '/prototypes/payment-detail',
      featured: true,
      screenshot: '/images/allocation_dashboard.png',
      insights: '5 proposed changes to the payment detail page covering summary fields, lockbox tracing, and allocation table improvements',
    },
    {
      id: 'api-docs',
